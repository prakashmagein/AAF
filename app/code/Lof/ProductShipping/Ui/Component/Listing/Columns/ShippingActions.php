...
namespace Lof\ProductShipping\Ui\Component\Listing\Columns;
...
{
    /** Url path */
    const CMS_URL_PATH_DELETE   = 'lofmpproductshipping/shipping/delete';
    const CMS_URL_PATH_EDIT   = 'lofmpproductshipping/shipping/edit';
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['lofshipping_id'])) {
                    ...
                    $item[$name]['delete'] = [
                            ...
                            'label' => __('Delete'),
                            'confirm' => [
                                'title' => __('Delete "%1"', $item['lofshipping_id']),

...
namespace Lof\ProductShipping\Model\ResourceModel\Shipping\Grid;

use Lof\ProductShipping\Model\ResourceModel\Shipping\Collection as ShippingCollection;
...
class Collection extends ShippingCollection implements SearchResultInterface
{
    ...
    protected function _initSelect()
    {
        ...
        parent::_initSelect();
        $this->join([
            'shippinglist'=>$this->getTable('lof_ps_rate_method')],
            'main_table.shipping_method_id =shippinglist.entity_id',
            [

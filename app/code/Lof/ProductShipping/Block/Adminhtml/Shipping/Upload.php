...
class Upload extends \Magento\Backend\Block\Widget\Form\Container
{
        ...
        parent::_construct();
         ...
         $this->buttonList->add(
                    ...
                    [
                        ...
                        'class' => 'save primary',
                        'onclick' => 'setLocation(\'' . $this->getUrl('lofproductshipping/*/save_upload') . '\')'
                    ]
    ...
    {
        if ($this->_coreRegistry->registry('lofproductshipping_shipping')->getId()) {
            return __("Edit Message '%1'", $this->escapeHtml($this->_coreRegistry->registry('lofproductshipping_shipping')->getTitle()));
        } else {

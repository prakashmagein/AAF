...
abstract class AttachmentAbstract implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function attachFile($observer, $pdfString, $fileName)
    {
        ...
        if (!class_exists('\Laminas\Mime\Part')) {
            return $this->attachFileZend($observer, $pdfString, $fileName);
        }
        ...
        $attachment = new \Laminas\Mime\Part($pdfString);
    ...
    public function attachFileZend($observer, $pdfString, $fileName)
    {
        /**
         * @var \Magento\Framework\Mail\Message $message
         */

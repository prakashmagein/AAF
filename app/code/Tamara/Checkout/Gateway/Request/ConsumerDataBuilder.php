...
class ConsumerDataBuilder implements BuilderInterface
{
    ...
    public function build(array $buildSubject)
    {
	    ...
	    $customer = $this->getCustomerModelById($order->getCustomerId());
            ...
            $consumer->setPhoneNumber($customer->getData('customer_mobile'));
    ...
    protected function getCustomerModelById($customerId)
    {

    ...
    'Magento_Ui/js/modal/modal'
        ...
        $.widget('magepow.ajaxcart', {
            ...
            _sendAjax: function (addUrl, data, oldAction, form=false) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.product_data_layer) {
                            window.dataLayer = window.dataLayer || [];
                            dataLayer.push(data.product_data_layer);
                        }
            ...
            _closePopup: function(){
                ...
                $body.find('.modal-popup:not(.popup-authentication, .customer-popup-ajaxwishlist, .md-popup.md-smsprofile-popup), .modals-overlay').remove();

...
class SMSProfileApiHelper
{
    ...
    public function __construct(
        ...
        GuestPaymentMethodManagementInterface $guestPaymentMethodManagement,
    ...
    public function validateNumber($mobile)
    {
        ...
        } elseif (strlen((string)$mobile) > $this->datahelper->getSmsProfilePhoneMaxLength()) {
    ...
    public function savePaymentInformation(
        ...
        $this->guestPaymentMethodManagement->set($cartId, $paymentMethod);
        return true;
    }

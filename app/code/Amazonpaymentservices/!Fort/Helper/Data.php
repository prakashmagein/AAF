...
class Data extends \Magento\Payment\Helper\Data
{
    ...
    private function errorReponse($responseCode, $order, $responseStatusMessage)
    {
        if ($responseCode == \Amazonpaymentservices\Fort\Model\Payment::PAYMENT_STATUS_CANCELED) {
            ...
            $responseMessage = __('Sorry, Tabby is unable to approve this purchase. Please use an alternative payment method for your order.');
            ...
            if($responseCode ==="13072"){
                $responseMessage = __('You aborted your payment. Please try again or choose another payment method');
            }else{

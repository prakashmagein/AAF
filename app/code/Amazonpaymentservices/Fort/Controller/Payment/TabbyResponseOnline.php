...
class TabbyResponseOnline extends \Amazonpaymentservices\Fort\Controller\Checkout implements CsrfAwareActionInterface, HttpGetActionInterface, HttpPostActionInterface
{
	...
	$writer = new \Zend_Log_Writer_Stream(BP . '/var/log/tabbyresponse.log');
        $logger = new \Zend_Log();
        $logger->addWriter($writer);
        $logger->info('Request Param:'.json_encode($responseParams));

...
namespace Aheadworks\RewardPoints\Model\EarnRule\Condition\Cart;
...
use Aheadworks\RewardPoints\Model\EarnRule\Condition\Cart\Product as ConditionProduct;
use Magento\CatalogRule\Model\Rule\Condition\Product;
use Magento\Rule\Model\Condition\Combine as RuleCombine;
use Aheadworks\RewardPoints\Model\EarnRule\Condition\Address as ConditionAddress;
...
class Combine extends RuleCombine
{
    ...
    public function getNewChildSelectOptions(): array
    {
        ...
        foreach ($addressAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'Aheadworks\RewardPoints\Model\EarnRule\Condition\Address|' . $code,
                'label' => $label,
            ];
        }
        ...
        foreach ($productAttributes as $code => $label) {
            $attributesProduct[] = [
                'value' => 'Aheadworks\RewardPoints\Model\EarnRule\Condition\Cart\Product|' . $code,
                'label' => $label,
            ];
        }

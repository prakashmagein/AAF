...
class Builder
{
     ...
     */
    public function searchSpendRules(): array
    {
        $searchResults = $this->spendRuleRepository
     ...
     * @return $this
     */
    public function addStatusFilter($status): Builder
    {
    ...
    /**
     * Add website ids filter condition type in
     *
     * @param array $ids
     * @return $this
     */
    public function addWebsiteIdsFilterIn(array $ids): Builder
    {
        $this->getSearchCriteriaBuilder()->addFilter(SpendRuleInterface::WEBSITE_IDS, $ids, 'in');
        return $this;
    }

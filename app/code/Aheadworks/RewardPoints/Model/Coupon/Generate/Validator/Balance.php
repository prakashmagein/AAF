...
class Balance implements ValidatorInterface
{
    /**
     * Validate balance for coupon generation
     *
    ...
    {
        if ($couponGenerateInfo->getBalance() <= 0) {
            throw new LocalizedException(__(self::INVALID_FIELD_MIN_VALUE, [
                'fieldName' => 'Coupon Balance',
                'value' => $couponGenerateInfo->getBalance(),
                'minValue' => 0
            ]));
        }
    }

...
{
    /**#@+
     * Product attributes used for individual product cost coverage rule
     */
    const AW_RP_SHARE_COVERED_ENABLED = 'aw_rp_share_covered_enabled';
    const AW_RP_SHARE_COVERED_PERCENT = 'aw_rp_share_covered_percent';
    /**#@-*/
}

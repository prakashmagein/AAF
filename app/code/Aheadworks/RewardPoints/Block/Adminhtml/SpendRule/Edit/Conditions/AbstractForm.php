...
use Aheadworks\RewardPoints\Model\SpendRule\Condition\Rule\Catalog as CatalogCondition;
...
abstract class AbstractForm
{
     ...
     */
    const FORM_NAME = 'aw_reward_points_spending_rules_form';
     ...
     * @return void
     */
    public function prepareForm(DataForm $form): void
    {
     ...
     * @return Fieldset
     */
    protected function addFieldsetToForm(DataForm $form): Fieldset
    {
    ...
    {
        $conditionRule = $this->conditionRule->create();
     ...
     *
     * @param Fieldset $fieldset
     * @param CatalogCondition $conditionData
     * @return void
     */
    protected function addFieldsToFieldset(Fieldset $fieldset, $conditionData): void
    {
        $fieldset

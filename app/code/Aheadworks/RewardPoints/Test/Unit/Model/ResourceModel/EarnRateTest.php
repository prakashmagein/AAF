    ...
    public function testGetRateRowIdMethod()
    {
        ...
        $this->connectionMock->expects($this->exactly(3))
            ...
            ->withConsecutive(
                ...
                ['aw_rp_earn_rate.website_id'],
                ['aw_rp_earn_rate.lifetime_sales_amount']
        ...
        $selectMock->expects($this->exactly(3))
            ...
            ->withConsecutive(
                ...
                ['`aw_rp_earn_rate`.`website_id`=?', $websiteId],
                ['`aw_rp_earn_rate`.`lifetime_sales_amount`<=?', $lifetimeSalesAmount]
            )->willReturnSelf();

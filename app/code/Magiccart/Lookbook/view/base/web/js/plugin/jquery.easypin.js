(function($){
    ...
    var viewLocater = function(data, markerIndex, parentWidth, markerContainer) {
        ...
        // added for the position updated in mobile only for the left

        if(pinLeft < 7){
            var pinLeftnew_x = pinLeft+6;
            $(".easypin-popover").css('left', pinLeftnew_x+'%')
        }
        if(pinLeft > 93){
            var pinLeftnew_y = 6;
            $(".easypin-popover").css('right', pinLeftnew_y+'%')
        }

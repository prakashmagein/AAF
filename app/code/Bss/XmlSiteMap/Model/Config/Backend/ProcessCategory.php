    ...
    public function beforeSave()
    {
        ...
        if ($value !== $oldValue) {
            ...
            foreach ($enableCategoryArray as $categoryId) {
                ...
                $categoryObject->setData('excluded_xml_sitemap', '0');
                $this->categoryResource->saveAttribute($categoryObject, 'excluded_xml_sitemap');
            }

            foreach ($newValueArray as $categoryId) {
                $categoryObject = $this->categoryRepository->get($categoryId, $storeId);
                $categoryObject->setData('excluded_xml_sitemap', '1');
                $this->categoryResource->saveAttribute($categoryObject, 'excluded_xml_sitemap');
            }
        }

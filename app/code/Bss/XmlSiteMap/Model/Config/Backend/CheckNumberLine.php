 ...
 */
class CheckNumberLine extends \Magento\Framework\App\Config\Value
{
    /**
     * Plugin before Save
     *
    ...
    public function beforeSave()
    {
        ...
        $value = $this->getValue();
        if ($value !== '' && is_numeric($value) && $value < 50) {
            throw new \Magento\Framework\Exception\ValidatorException(__($label . ' is less than 50 lines.'));
        }

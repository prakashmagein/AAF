...
return [
    'modules' => [
        ...
        'Aheadworks_Buildify' => 1,
        'Aheadworks_RewardPoints' => 1,
        'Aheadworks_RewardPointsGraphQl' => 1,
        'Amasty_AdminActionsLog' => 1,
        'Amasty_Base' => 1,
        'Amasty_AutomaticRelatedProductsSubscriptionPackage' => 1,
        'Amasty_AdminActionsLogSubscriptionPackage' => 1,
        ...
        'Customization_Checkout' => 0,
        'FME_Refund' => 1,
        'Gwl_Checkoutvalidation' => 1,
        'Gwl_OrderDetails' => 1,
        'Gwl_Priceconvert' => 1,
        'Keij_AppleLogin' => 1,
        'MageWorx_SearchSuiteAutocomplete' => 1,
        'Magedelight_Base' => 1,
        'Magedelight_SMSProfile' => 1,
        'Magefan_AdminUserGuide' => 1,
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
        'Magefan_BlogGraphQl' => 1,
        'Magefan_FacebookPixel' => 1,
